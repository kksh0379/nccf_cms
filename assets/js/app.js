...
/* restart v26: no-rerender signup consent + benefit detail popup */
...
// Restart v7: floating support popup actions
(function(){
...
// Restart v13: main homepage and valuejieum page navigation behavior.
(function(){
...
// Restart v27: keyboard access for benefit cards without visible repeated buttons.
...
(function(){
  /* v59_37: 잠금 상태는 화면에 실시간 노출하지 않고 로그인 시도 결과로만 안내 */
  ...
  /* 이전 데모 버전에서 남은 잠금 상태 때문에 즉시 잠기는 문제 방지 */
...
(function(){
  ...
  /* Rebuild login after v96 renderer so the globe icon is always present. */
  ...
  /* Existing active screen is repainted once so the selector patch is visible immediately. */
...
(function(){
  ...
  // Account-flow helpers used by later account patches
  window.shell=shell;
  window.field=field;
